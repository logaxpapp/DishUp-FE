        ...
        <div className="relative hidden lg:flex items-center justify-center px-14 py-16">
          ...
          <div className="relative w-full max-w-[520px]">
            ...
            <motion.div variants={container} initial="hidden" animate="visible" className="pt-10">
              <motion.div variants={item} className="inline-flex items-center gap-2 rounded-full border border-orange-200 bg-white/70 px-4 py-2 text-sm font-semibold text-gray-800 shadow-sm backdrop-blur">
              ...
              >
                Create your <span className="text-orange-600">LogaDash</span> account.
              </motion.h1>
              ...
              >
                Start taking orders, tracking deliveries, and managing your operations in one clean dashboard.
              </motion.p>
          ...
          >
            ...
            >
              <form className="space-y-5" onSubmit={handleSubmit}>
                {/* NOTE: keep your Input API exactly, just feed props */}
                <Input label="Restaurant Name" type="text" placeholder="Mama Dee" required />
                <Input label="Full Name" type="text" placeholder="Owner’s name" required />
                ...
                <div className="pt-1 text-xs text-gray-500 leading-relaxed">
                  ...
                  <Link href="/terms" className="text-gray-700 hover:text-gray-900 font-semibold">
                    Terms
                  </Link>{" "}
                  and{" "}
                  <Link href="/privacy" className="text-gray-700 hover:text-gray-900 font-semibold">
                    Privacy Policy
                  </Link>
                  .
                </div>
