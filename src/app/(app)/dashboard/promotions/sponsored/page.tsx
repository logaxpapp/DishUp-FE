  ...
  return (
    <div className="min-h-screen bg-orange-50/30">
      ...
      <header className="bg-white px-8 py-4 flex items-center justify-between border-b">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Sponsored Listing</h1>
      ...
      <div className="p-8">
        ...
        <div className="flex items-center gap-2 mb-6 text-sm">
          ...
          <button className="text-gray-900 font-medium">Sponsored</button>
          <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
          </svg>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white rounded-xl p-4 shadow-sm relative overflow-hidden">
            ...
            <div className="mt-2 h-1 bg-gray-200 rounded-full">
              <div className="h-1 bg-yellow-400 rounded-full" style={{ width: '70%' }}></div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-4 shadow-sm relative overflow-hidden">
            ...
            <div className="mt-2 h-1 bg-gray-200 rounded-full">
              <div className="h-1 bg-yellow-400 rounded-full" style={{ width: '60%' }}></div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-4 shadow-sm relative overflow-hidden">
            ...
            <div className="mb-2">
              ...
              <h3 className="text-2xl font-bold text-gray-900">10% VS 8.5%</h3>
            </div>
            <p className="text-xs text-gray-500">CTR</p>
            <div className="mt-2 h-1 bg-gray-200 rounded-full">
              <div className="h-1 bg-yellow-400 rounded-full" style={{ width: '80%' }}></div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-4 shadow-sm relative overflow-hidden">
            ...
            <div className="mt-2 h-1 bg-gray-200 rounded-full">
              <div className="h-1 bg-yellow-400 rounded-full" style={{ width: '50%' }}></div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200">
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500">Campaign Name</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500">Status</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500">Total Views</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500">Clicks</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500">CTR</th>
            ...
            <tbody>
              {listings.map((listing, index) => (
                <tr key={index} className="border-b border-gray-100 hover:bg-gray-50">
                  <td className="px-6 py-3 text-sm text-gray-900">{listing.campaignName}</td>
                  <td className="px-6 py-3">
                    <span className="inline-flex px-2 py-1 bg-green-100 text-green-700 text-xs rounded">
                      {listing.status}
                    </span>
                  </td>
                  <td className="px-6 py-3 text-sm text-gray-600">{listing.totalViews}</td>
                  <td className="px-6 py-3 text-sm text-gray-600">{listing.clicks}</td>
                  <td className="px-6 py-3 text-sm text-gray-600">{listing.ctr}</td>
                  <td className="px-6 py-3 text-sm text-gray-600">{listing.duration}</td>
                  <td className="px-6 py-3">
          ...
          <div className="px-6 py-3 border-t flex items-center justify-between">
            ...
            <div className="flex items-center gap-1">
              ...
              <button className="w-6 h-6 flex items-center justify-center rounded hover:bg-gray-100 text-xs">6</button>
              <button className="w-6 h-6 flex items-center justify-center rounded hover:bg-gray-100 text-xs">7</button>
            </div>
          </div>
        </div>
      </div>

      {/* Add New Sponsored List Modal */}
      {isAddModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-6 max-w-md w-full">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-gray-900">Add New Sponsored List</h2>
              <button
            ...
            <form className="space-y-4">
              <div>
                ...
                <input
                  type="text"
                  placeholder="Select featured Products/list"
